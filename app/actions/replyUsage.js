...
So, please don't ask usage questions here. You can try to ask questions on Stack Overflow or [Segment Fault](https://segmentfault.com/t/ng-zorro), then apply tag 'antd' and 'ng-zorro' to your question.
Maintaining open source projects is hard work, Thanks for your understanding!

----------
你好 @{user}，NG ZORRO的GitHub issue 列表严格地限制用于有具体目标和内容的工作(如提交Bug和提交requests)。使用问题和讨论应当发送到更适合它们的场合，去Stack Overflow 或者Segment Fault 提问并贴上 ng-zorro 标签，让更多的开发者参与讨论。
